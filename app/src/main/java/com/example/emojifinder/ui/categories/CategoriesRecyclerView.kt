...
class HorizontalCarouselRecyclerView(
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, R.color.buttonBlueColor) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.background_color) }
