...
package com.example.emojifinder.domain

import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import com.example.emojifinder.domain.internal.DefaultScheduler
import com.example.emojifinder.domain.internal.Scheduler
...
abstract class UseCase<in P, R> {
    ...
    operator fun invoke(parameters: P, result: MutableLiveData<Result<R>>) {
        // result.value = com.example.emojifinder.domain.result.Result.Loading TODO: add data to Loading to avoid glitches
        try {
